...
.Link
https://github.com/microsoft/ARI/Modules/Public/InventoryModules/AI/Translator.ps1
...
Else
{
    ...
    if($SmaResources)
    {
        ...
        $TableName = ('TranslaTable_'+(($SmaResources.'Resource U' | Measure-Object -Sum).Sum))
